 ...
 */
public class ImageViewArrayAdapter extends  ArrayAdapter<ContentValues> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Picasso.with( getContext() ).load( Utility.getImageUrl(getContext()) + MovieValues.getMoviePoster(cv))
