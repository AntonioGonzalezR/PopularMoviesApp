...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static final Class<?>[] INNER_CLASSES =
    ...
    private static void bindPreferenceSummaryToValue(Preference preference) {
        ...
        sBindPreferenceSummaryToValueListener.onPreferenceChange(preference,
                PreferenceManager
                        ...
                        .getString(preference.getKey(), preference.getContext().getString(R.string.pref_values_movies_sort_order_default )));
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindPreferenceSummaryToValue(findPreference(getString(R.string.pref_key_movies_sort_order)));
        }
    }
}
